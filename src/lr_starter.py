...
models = ["Deep+_mobile"]
#, "Deep_mobile_lstmV1", "Deep_mobile_lstmV2_1", "Deep_mobile_lstmV2_2", "Deep_mobile_lstmV3",
          # "Deep_mobile_lstmV4",
...
for model in models:
    ...
    config["save_folder_path"] = "src/models/LR_Tests_wd/tests/"  # bs_" + str(config["batch_size"])
